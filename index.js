...
let groups = [{url: "https://eleves.groupe3il.fr/edt_eleves/I2%20Groupe%205%20FA.xml"  , id: "i1g5"} , {url: "https://eleves.groupe3il.fr/edt_eleves/I2%20Groupe%206%20FA.xml"  , id: "i2g6"} ]
let res;
        ...
        .then((data) => {
            ...
            JSON.parse(res).DOCUMENT.GROUPE[0].PLAGES.map((plage) => {
                ...
                if (events.length > 0) {
                    ...
                    fs.writeFileSync("./" + group.id+".ics", value);
                }
